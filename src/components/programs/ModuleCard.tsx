  ...
  return (
    <motion.div
      ...
      className={`rounded-2xl overflow-hidden shadow-lg ${
        isEven ? 'bg-white' : 'bg-gradient-to-br from-primary-50 to-creative-50'
      }`}
    >
      {/* Header */}
      <div className="p-8">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-primary-600 font-semibold mb-4">{module.tagline}</p>
        ...
        <button
          ...
          className="mt-6 flex items-center gap-2 text-primary-600 font-semibold hover:gap-3 transition-all"
