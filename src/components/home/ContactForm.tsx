        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-4 text-lg">
              Fill out this form and we&apos;ll reach out to schedule a FREE interactive session at your school.
            </p>
            ...
            {status === 'success' && (
              <motion.div
                ...
                className="mt-6 p-4 bg-success-50 border border-success-200 rounded-2xl flex items-start gap-3"
              >
                <CheckCircle className="w-5 h-5 text-success-600 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-success-800">Thank you for your interest!</p>
            ...
            {status === 'error' && (
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mt-6 p-4 bg-warm-50 border border-warm-200 rounded-2xl flex items-start gap-3"
              >
                <AlertCircle className="w-5 h-5 text-warm-600 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-medium text-warm-800">Submission failed</p>
                  <p className="text-warm-700 text-sm mt-1">{errorMessage}</p>
                </div>
              </motion.div>
            )}
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 mb-6">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#25D366] text-white py-3.5 rounded-2xl font-bold hover:bg-[#22c55e] transition-colors"
              >
            ...
            {/* What to expect */}
            <div className="bg-gradient-to-br from-primary-50 via-creative-50 to-energy-50 rounded-3xl p-6 border border-primary-100">
              <h3 className="font-semibold text-gray-900 font-heading text-lg mb-4">
                What happens next?
              </h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <span className="w-7 h-7 rounded-lg bg-primary-100 text-primary-600 text-sm font-bold flex items-center justify-center flex-shrink-0">
                      {index + 1}
                    </span>
