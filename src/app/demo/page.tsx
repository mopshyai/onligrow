...
import { Sparkles, Target, Trophy, School, Projector, Clock, MessageCircle } from 'lucide-react';
...
/**
 * FAQ items with Hindi-English mix
 */
const faqs = [
  {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="One session. 45 minutes. Zero cost. See the impact before committing to anything."
        breadcrumbs={[{ label: 'Book Demo' }]}
      />
      ...
      <SectionWrapper>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Within 48 hours, we share a customized proposal for your school. If you're interested, we start a <strong>free 3-month pilot</strong> for 1-2 classes — no cost, no commitment. You experience the full OnliGrow partnership before deciding anything.
          </p>
        </div>
      </SectionWrapper>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq) => (
              ...
              >
                <h3 className="font-semibold text-dark mb-2 text-lg">{faq.q}</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">
              Fill out the form and we&apos;ll get back to you within 24 hours. Or skip the form and message us directly on WhatsApp.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <span className="text-gray-600">Prefer WhatsApp?</span>
                <a
                  href={CONTACT.whatsappLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#25D366]/90 transition-colors"
                >
              ...
              <p className="text-center text-sm text-gray-500 mt-4">
                Pre-filled message: &quot;Hi OnliGrow, I&apos;d like to book a free demo session for my school.&quot;
              </p>
            </div>
          </div>
        </div>
