      ...
      <SectionWrapper>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            <section>
              <h2 className="text-2xl font-bold text-dark mb-4">1. Data We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-dark mb-4">2. How We Use Data</h2>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>Respond to inquiries</li>
                <li>Deliver programs</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-dark mb-4">3. Data Retention</h2>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>Contact forms: 1 year</li>
                <li>Partner schools: Partnership + 2 years</li>
                <li>Student data: Program completion + 6 months (or earlier on request)</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-dark mb-4">4. Your Rights (DPDPA)</h2>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
